        ...
        <div className="flex flex-col space-y-14">
          {WorkHistories.map((experience, index) => (
            <div key={experience.company} className="flex flex-col items-center justify-center space-y-6 lg:space-y-0 md:justify-between md:items-start gap-7 md:flex-row">
              <div className={cn('w-full space-y-2 lg:w-1/2 order-1', [index % 2 === 0 ? 'md:order-1' : 'md:order-2'])}>
              ...
              <div
                className={cn('relative inline-flex w-full group overflow-hidden lg:w-1/2 bg-lead-gradient rounded-2xl order-2', [index % 2 === 0 ? 'md:order-2' : 'md:order-1'])}
              >
                <Image
